...
TEST_CASE("Good Input") {
    ...
    CHECK(notebook.read(3,5,3,Direction::Horizontal,5) != "(-.-)");
    CHECK(notebook.read(3,5,3,Direction::Horizontal,5) != "(...)");
    CHECK(notebook.read(3,5,3,Direction::Horizontal,5) == "()_()");
    ...
    CHECK(notebook.read(5,0,0,Direction::Horizontal,6) == "@@@@@@@");
    CHECK(notebook.read(5,1,0,Direction::Horizontal,6) == "@-----@");
    CHECK(notebook.read(5,2,0,Direction::Horizontal,6) == "@-@@@-@");
    CHECK(notebook.read(5,3,0,Direction::Horizontal,6) == "@-@-@-@");
    CHECK(notebook.read(5,4,0,Direction::Horizontal,6) == "@-@@@-@");
    CHECK(notebook.read(5,5,0,Direction::Horizontal,6) == "@-----@");
    CHECK(notebook.read(5,6,0,Direction::Horizontal,6) == "@@@@@@@");
